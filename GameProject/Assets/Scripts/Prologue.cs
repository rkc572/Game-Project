...
public class Prologue : MonoBehaviour
{
    ...
    List<string> prologueLines = new List<string>() {
        ...
        "These beings represented the four aspects of life necessary to maintain balance in the world: fire, water, air, and earth.",
        ...
        "Temples were built for them and in the capital city of Creley, the Elemental Knights Order was formed, for the entities are not all-powerful, and there are some who seek to take advantage of their benevolent and pacifist nature.",
        "Many have tried to seize the entities so that they may hold the power to control nature in their own hands, but the Knights have always managed to prevent their efforts.",
        "Except for Aldruin's.",
        "Aldruin is a powerful sorcerer of unknown origin.",
        "As a master of the dark arts, he overpowered nearly all the Knights of Creley and took control of the four entities.",
        ...
        "Your name is Everard, a newly knighted member of the Order.",
        "As a new recruit, you were not present at the battle of Nightwell Keep, where Aldruin resides.",
        "As such, you are one of the few remaining Knights.",
        "However, when word arrived that the Knights at Nightwell Keep had been wiped out, humanity fell into despair, and the remaining Knights all lost heart.",
        "All but you.",
