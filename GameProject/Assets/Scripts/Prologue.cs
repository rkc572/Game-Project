...
public class Prologue : MonoBehaviour
{
    ...
    List<string> prologueLines = new List<string>() {
        ...
        "Temples were built for them and in the capital city of Creley, the Elemental Knights Academy was formed, for the entities are not all-powerful, and there are some who seek to take advantage of their benevolent and pacifist nature.",
        "Many have tried to seize the entities so that they may hold their power in their own hands, but the Knights have always managed to prevent their efforts.",
        ...
        "Your name is Everard, a newly knighted member.",
